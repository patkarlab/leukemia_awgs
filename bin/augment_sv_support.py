...
def main():
    ...
    for r in rows:
        ...
        if present:
            ...
            n_pop += 1
        # Worst FILTER across the callers that saw this junction. SURVIVOR
        # stamps PASS on every merged record, so the merged filter column
        # carries no quality information; this one does.
